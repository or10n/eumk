<?php
        ...
        $mcImageManagerConfig['general.tools'] = "createdir,upload,refresh,addfavorite,removefavorite,insert,delete,edit,preview";
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../_images'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../_images'; // absolute or relative from this script path, required.
