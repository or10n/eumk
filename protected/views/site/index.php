...
<table class="img_content" border="0" cellpadding="4" cellspacing="0">
	<tr> 
		<td width=25% align=center>
			<em><a href="" target="_blank" title="Программа курса (Откроется в новом окне)">
		...
		<td width=25% align=center>
			<em><a href="http://<?=$_SERVER['HTTP_HOST']?>/index.php?r=contents&type=1">
		...
		<td width=25% align=center>
			<em><a href="http://<?=$_SERVER['HTTP_HOST']?>/index.php?r=contents&type=3">
		...
		<td width=25% align=center>
			<em><a href="http://<?=$_SERVER['HTTP_HOST']?>/index.php?r=contents&type=4">
